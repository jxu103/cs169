...
#ifndef MPARF_WIFI_MANAGER_H
#define MPARF_WIFI_MANAGER_H

#include "wifi-remote-station-manager.h"

namespace ns3 {

struct mParfWifiRemoteStation;
/**
 * \ingroup wifi
 ...
 *
 */
class mParfWifiManager : public WifiRemoteStationManager
{
public:
  /**
   * Register this type.
...
private:
   ...
   */
  void CheckInit (mParfWifiRemoteStation *station);
